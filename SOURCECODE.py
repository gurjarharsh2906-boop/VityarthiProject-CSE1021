...
# Author: Harsh Gurjar 25BCE11195
# Date: 23 NOV 2025
...
class Estimator:
    ...
    def export_report(self, filename: str, rate_per_kwh: float) -> None:
        lines = []
        lines.append("Electricity Bill Estimator — Report")
        lines.append("===============================================\n")
...
def main_menu():
    ...
    while True:
        print("\nMenu:")
        print("1. Add Home appliance")
        print("2. Remove Home appliance")
        print("3. List Home appliances")
